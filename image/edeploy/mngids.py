...
def parse_cmdline(args, uids, gids, first=100, last=999, last_user=29999):
    ...
    if args0 == 'adduser' or args0 == 'useradd':
        ...
        if idx:
            ...
            # that case a group is created with the same name as the
            # username by the
            # useradd command. So if we want to specify a specific gid
            # (according to ids.tables) we need to create the group here.
            # Plus this mimic the useradd command.
            call_addgroup(arg1)
