...
fetch_edeploy
PYSFLIB_PINNED_VERSION=${PYSFLIB_PINNED_VERSION} MANAGESF_PINNED_VERSION=${MANAGESF_PINNED_VERSION} CAUTH_PINNED_VERSION=${CAUTH_PINNED_VERSION} ./edeploy/fetch_subprojects.sh
echo
build_roles
