...
.. code-block:: bash
 ...
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password create --name <project-name>
...
.. code-block:: bash
 ...
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password delete --name <project-name>
...
.. code-block:: bash
 ...
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password add_user --name user1 --groups p1-ptl,p1-core
...
.. code-block:: bash
 ...
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password delete_user --name user1 --group p1-ptl
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password delete_user --name user1
...
.. code-block:: bash
 ...
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password backup_get
...
.. code-block:: bash
 ...
 $ sfmanager --url <http://sfgateway.dom> --auth-server-url <http://sfgateway.dom> --auth user:password restore --filename sf_backup.tar.gz
