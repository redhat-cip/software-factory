...
ROLES="${SF_PREFIX}-puppetmaster ${SF_PREFIX}-ldap ${SF_PREFIX}-mysql ${SF_PREFIX}-redmine ${SF_PREFIX}-gerrit ${SF_PREFIX}-managesf ${SF_PREFIX}-jenkins ${SF_PREFIX}-commonservices"
